...
- It requires that all folders (<batch_name>/) are stored in <dir_sequences> directory. dir_sequences/batches/achromobacter_xylosoxidans__01
...
KMER=sum([int(x) for x in MASKS[0]]); print("Kmer size FCGR:", KMER)
